    ...
    <section id="contact" className="py-16 md:py-24 px-5">
      <div className="container max-w-4xl text-center">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 mb-8 md:mb-12">
          <a href="mailto:islambadea124@gmail.com" className="border border-border rounded-lg p-3 sm:p-4 md:p-6 bg-card card-hover flex flex-col items-center gap-1.5 sm:gap-2 md:gap-3">
            <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
            <span className="text-[10px] sm:text-xs md:text-sm text-foreground font-mono">Email</span>
          </a>
          <a href="https://github.com/IslamBadie" target="_blank" rel="noopener noreferrer" className="border border-border rounded-lg p-3 sm:p-4 md:p-6 bg-card card-hover flex flex-col items-center gap-1.5 sm:gap-2 md:gap-3">
          ...
          <a href="https://www.linkedin.com/in/islam-abdelbadie" target="_blank" rel="noopener noreferrer" className="border border-border rounded-lg p-3 sm:p-4 md:p-6 bg-card card-hover flex flex-col items-center gap-1.5 sm:gap-2 md:gap-3">
