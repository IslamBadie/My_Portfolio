    ...
    <section id="contact" className="py-24 px-4">
      <div className="container max-w-4xl text-center">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          ...
          <a <a href="https://www.linkedin.com/in/islam-abdelbadie/" target="_blank" rel="noopener noreferrer" className="border border-border rounded-lg p-6 bg-card card-hover flex flex-col items-center gap-3"> target="_blank" rel="noopener noreferrer" className="border border-border rounded-lg p-6 bg-card card-hover flex flex-col items-center gap-3">
